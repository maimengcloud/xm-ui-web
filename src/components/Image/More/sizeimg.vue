<template>
	...
	<div class="SpeListOverFlow">
		...
		<el-col :span="6" v-for="(o, index) in imageLists" style="margin-right:5px">
		    <el-card :body-style="{ padding: '0px' }">
		      <div class="avatar-uploader" @click="selectedImage(index)">
		      	<div style="height: 58px;width: 86px;display: flex;">
		...
		<el-col :span="6" v-if="showAdd=='true'">
		    <el-card :body-style="{ padding: '0px' }">
		      <div style="padding: 14px;" class="avatar-uploader-t" @click="addImg">
