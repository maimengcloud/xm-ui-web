<template>
	<div>
		<el-row v-loading="elRowLoading">
			...
			<el-col :span="15">
				<el-col :span="5" style="margin-left:70px;"><el-input v-model="filterBusinessName"  placeholder="模糊查询"></el-input></el-col> 
				...
				<el-table    ref="multipleTable" :data="shopLocationTable" style="width: 100%;margin-left:70px;"   @selection-change="handleSelectionChange">
					...
					<el-table-column prop="id" label="门店编号" width="180" align="center">
					</el-table-column>
					<el-table-column prop="businessName" label="门店名称" align="center">
					</el-table-column>
	...
	export default {
		...
		methods: {
			...
			selectshopLocationBySysDeptIdMethod() {
				...
				if(this.filterBusinessName!=null && this.filterBusinessName!=''){//店名模糊搜索
