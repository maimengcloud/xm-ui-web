        ...
        <el-table :data="xmTasks"   :max-height="400"  v-loading="load.list" @selection-change="selsChange" @row-click="rowClick">
          ...
          <el-table-column prop="name" label="名称" min-width="300">
            ...
            <el-table-column prop="rate" label="进度"  width="100">
              ...
              >
								<template slot-scope="scope">
                  <mdp-select-user show-style="tag" @visible-change="selectVisible(scope.row,$event)" v-model="scope.row.creatorUserid" :init-name="scope.row.createUsername" @change2="editXmTaskSomeFields(scope.row,'creatorUserid',$event)"></mdp-select-user>
