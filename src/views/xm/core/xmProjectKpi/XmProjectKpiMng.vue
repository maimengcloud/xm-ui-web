<template>
	<section>
		<el-row   class="xm-kpi">
			...
			<el-table ref="table" height="100px" v-adaptive="{bottomOffset:50}" :data="xmProjectKpis" @sort-change="sortChange" highlight-current-row v-loading="load.list" border @selection-change="selsChange" @row-click="rowClick" style="width: 100%;">
