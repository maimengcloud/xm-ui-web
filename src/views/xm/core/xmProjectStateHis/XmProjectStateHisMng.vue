<template>
	<section class="page-container border padding">
		...
		<el-row class="padding-top">
			...
			<el-table ref="xmProjectStateHisTable" :data="xmProjectStateHiss" height="100px" v-adaptive="{bottomOffset:50}" @sort-change="sortChange" highlight-current-row v-loading="load.list" border @selection-change="selsChange" @row-click="rowClick" style="width: 100%;">
				...
				<el-table-column prop="menuFinishCnt" label="完成的故事数" min-width="80" show-overflow-tooltip></el-table-column>
...
<script>
	...
	import  XmProjectStateHisEdit from './XmProjectStateHisEdit';//新增修改界面
	...
	export default {
		...
		methods: {
			...
			//获取列表 XmProjectStateHis 项目指标日统计表
			...
			//显示编辑界面 XmProjectStateHis 项目指标日统计表
			showEdit: function ( row,index ) {
				this.editFormVisible = true;
				this.editForm = Object.assign({}, row);
			},
			//显示新增界面 XmProjectStateHis 项目指标日统计表
			showAdd: function () {
