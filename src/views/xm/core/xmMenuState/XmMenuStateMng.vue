<template>
	<section class="page-container  padding border">
		...
		<el-row class="page-main" v-show="!batchEditVisible">
				<el-table ref="table" height="100px" v-adaptive="{bottomOffset:50}" :data="xmMenusTreeData" default-expand-all  row-key="menuId" :tree-props="{children: 'children', hasChildren: 'hasChildren'}" @sort-change="sortChange" highlight-current-row v-loading="load.list" border @selection-change="selsChange" @row-click="rowClick" style="width: 100%;">
