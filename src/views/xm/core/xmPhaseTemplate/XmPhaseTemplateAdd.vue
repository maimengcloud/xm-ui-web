		...
		<el-row>
			...
			<el-form :model="addForm"  label-width="120px" :rules="addFormRules" ref="addForm"> 
				...
				<el-form-item label="内部人力成本总预算" prop="phaseBudgetIuserAt">
					<el-input-number v-model="addForm.phaseBudgetIuserAt" :precision="2" :step="1000" :min="0" placeholder="内部人力成本总预算(不包括下一级)-应该大于或等于任务中内部人力总成本"></el-input-number> <el-tag>参考{{autoParams.phaseBudgetIuserAt}}元，{{this.toFixed(autoParams.phaseBudgetIuserAt/10000)}}万元</el-tag>
				</el-form-item> 
				<el-form-item label="外购人力成本总预算" prop="phaseBudgetOuserAt">
					<el-input-number v-model="addForm.phaseBudgetOuserAt" :precision="2" :step="1000" :min="0" placeholder="外购人力成本总预算(不包括下一级)-应该大于或等于任务中外购总成本"></el-input-number> <el-tag>参考{{autoParams.phaseBudgetOuserAt}}元，{{this.toFixed(autoParams.phaseBudgetOuserAt/10000)}}万元</el-tag>
				</el-form-item>
				<el-form-item>
