<template>
	<section class="border padding">
		...
		<el-row class="padding-top">
			<!--列表 XmFunc 功能模块表-->
			<el-table ref="xmFuncTable" :data="xmFuncs" height="100px" v-adaptive="{bottomOffset:50}" @sort-change="sortChange" highlight-current-row v-loading="load.list" border @selection-change="selsChange" @row-click="rowClick" style="width: 100%;">
