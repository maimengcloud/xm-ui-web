<template>
	<section>
		...
		<!--编辑界面 XmMenuPlan 功能计划表,无需前端维护，所有数据由汇总统计得出--> 
	...
	export default { 
		...
		data() {
			return {
				...
				//编辑界面数据  XmMenuPlan 功能计划表,无需前端维护，所有数据由汇总统计得出
				editForm: {
		...
		methods: {
			...
			//编辑提交XmMenuPlan 功能计划表,无需前端维护，所有数据由汇总统计得出父组件监听@submit="afterEditSubmit"
			editSubmit: function () {
		...
		components: {  
		    //在下面添加其它组件 'xm-menu-plan-edit':XmMenuPlanEdit
		},
		mounted() {
