<template>
	<section class="page-container padding border">
				...
				<el-row class="page-main">
						...
						<el-table ref="table" :load="loadXmTaskLazy" height="100px" v-adaptive="{bottomOffset:50}" :data="xmTaskTemplatesTreeData" row-key="id" :tree-props="{children: 'children', hasChildren: 'childrenCnt'}" @sort-change="sortChange" highlight-current-row v-loading="load.list" border @selection-change="selsChange" @row-click="rowClick" style="width: 100%;">
