<template>
	<section class="page-container border padding">
		...
		<el-row class="padding-top">
			...
			<el-table ref="xmBranchStateTable" :data="xmBranchStates" height="100px" v-adaptive="{bottomOffset:50}" @sort-change="sortChange" highlight-current-row v-loading="load.list" border @selection-change="selsChange" @row-click="rowClick" style="width: 100%;">
