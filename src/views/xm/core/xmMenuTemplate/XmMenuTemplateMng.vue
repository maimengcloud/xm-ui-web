<template>
	<section class="page-container border padding">
		<el-row class="page-main">
				...
				<el-table :load="loadMenusLazy" ref="table" height="100px" v-adaptive="{bottomOffset:50}" :data="xmMenuTemplatesTreeData"   row-key="menuId" :tree-props="{children: 'children', hasChildren: 'childrenCnt'}" @sort-change="sortChange" highlight-current-row v-loading="load.list" border @selection-change="selsChange" @row-click="rowClick" style="width: 100%;">
