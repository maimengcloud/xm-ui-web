<template>
	<section class="page-container  padding border">
		...
		<el-row class="page-main ">
			...
			<el-table ref="table" height="100px" v-adaptive="{bottomOffset:50}" :data="xmTaskSkills" @sort-change="sortChange" highlight-current-row v-loading="load.list" border @selection-change="selsChange" @row-click="rowClick" style="width: 100%;">
