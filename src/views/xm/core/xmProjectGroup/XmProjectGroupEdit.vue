	...
	export default { 
		...
		data() {
			return {
				...
				//编辑界面数据  XmProjectGroup xm_project_group
				editForm: {
		...
		methods: {
			...
			//编辑提交XmProjectGroup xm_project_group父组件监听@submit="afterEditSubmit"
			editSubmit: function () {
		...
		components: {  
		    //在下面添加其它组件 'xm-project-group-edit':XmProjectGroupEdit
		},
		mounted() {
