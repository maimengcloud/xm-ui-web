<template>
	<section>
		<el-row v-if="!InfoVisible" class="xm-file">
			...
			<!--列表 XmFile xm_file-->
			<el-table ref="table" height="100px" v-adaptive="{bottomOffset:50}" :data="xmFiles" @sort-change="sortChange" highlight-current-row v-loading="load.list" border @selection-change="selsChange" @row-click="rowClick" style="width: 100%;">
