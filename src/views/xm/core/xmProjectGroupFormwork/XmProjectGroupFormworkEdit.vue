	...
	export default { 
		...
		data() {
			return {
				...
				//编辑界面数据  XmProjectGroupFormwork xm_project_group_formwork
				editForm: {
		...
		methods: {
			...
			//编辑提交XmProjectGroupFormwork xm_project_group_formwork父组件监听@submit="afterEditSubmit"
			editSubmit: function () {
		...
		components: {  
		    //在下面添加其它组件 'xm-project-group-formwork-edit':XmProjectGroupFormworkEdit
		},
		mounted() {
