	...
	<section>
		...
		<el-row class="app-container"> 
			...
			<el-table :data="branchs" @sort-change="sortChange" highlight-current-row v-loading="load.list" border @selection-change="selsChange" @row-click="rowClick" style="width: 100%;">
				...
				<el-table-column prop="id" label="机构编号" min-width="80" ></el-table-column>
				<el-table-column prop="branchName" label="机构名称" min-width="80" ></el-table-column> 
				<el-table-column prop="industryCategory" label="行业分类" min-width="80" ></el-table-column> 
				...
				<el-table-column prop="phoneNo" label="联系电话" min-width="80" ></el-table-column>
				<el-table-column prop="emaill" label="邮件" min-width="80" ></el-table-column>
...
<script>
	...
	import { listBranch, delBranch, batchDelBranch } from '@/api/mdp/sys/branch';
