<template>
	<section>
		<el-row class="app-container"> 
			...
			<el-button type="primary" v-loading="load.list" :disabled="load.list==true" v-on:click="searchDeptPostUserRoles" icon="el-icon-search"></el-button> 
		</el-row>
		<el-row class="app-container"> 
...
<script>
	...
	import { listDeptPostUser, delDeptPostUser, batchDelDeptPostUser,listDeptPostUserRoles } from '@/api/mdp/sys/post/deptPostUser';
	...
	export default { 
		...
		methods: { 
			...
			getDeptPostUserRoles() {
				...
				this.load.list = true;
				listDeptPostUserRoles(params).then((res) => {
