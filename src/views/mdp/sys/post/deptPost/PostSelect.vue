<template>
	<section>
		<el-row class="app-container"> 
			...
			<el-button type="primary" @click="confirmPostSelect">确定</el-button> 
		...
		<el-row class="app-container"> 
			<!--列表 Post sys_post-->
			<el-table :max-height="tableHeight" :data="posts"  highlight-current-row v-loading="load.list" border @selection-change="selsChange" @row-click="rowClick" style="width: 100%;">
	...
	export default {  
		...
		methods: { 
			...
			getPosts() {
				...
				this.load.list = true;
				listPostNotInDeptid(params).then((res) => {
