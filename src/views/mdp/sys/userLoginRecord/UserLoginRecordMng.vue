<template>
	<section class="page-container border padding">
		...
		<el-row>
			<!--编辑 UserLoginRecord 用户登录信息登记界面-->
			<el-drawer title="编辑用户登录信息登记" :visible.sync="editFormVisible"  size="60%"  append-to-body   :close-on-click-modal="false">
				  <user-login-record-edit op-type="edit" :user-login-record="editForm" :visible="editFormVisible" @cancel="editFormVisible=false" @submit="afterEditSubmit"></user-login-record-edit>
			</el-drawer>

			<!--新增 UserLoginRecord 用户登录信息登记界面-->
			<el-drawer title="新增用户登录信息登记" :visible.sync="addFormVisible"  size="60%"  append-to-body  :close-on-click-modal="false">
				<user-login-record-edit op-type="add" :visible="addFormVisible" @cancel="addFormVisible=false" @submit="afterAddSubmit"></user-login-record-edit>
			</el-drawer>
	    </el-row>
	</section>
</template>
...
<script>
	...
	import  UserLoginRecordEdit from './UserLoginRecordEdit';//新增修改界面
