	...
	<section>
		...
		<el-row class="app-container">
			...
			<el-table :max-height="tableHeight" :data="userTpas"  highlight-current-row v-loading="load.list" border @selection-change="selsChange" @row-click="rowClick" style="width: 100%;">
				...
				<el-table-column sortable prop="locked" label="是否被锁定" min-width="80" show-overflow-tooltip></el-table-column>
				...
				<el-table-column sortable prop="headimgurl" label="头像地址" min-width="80" show-overflow-tooltip></el-table-column>
				...
				<el-table-column sortable prop="branchId" label="云用户机构编号" min-width="80" show-overflow-tooltip></el-table-column>
...
<script>
	...
	import { listUserTpa, delUserTpa, batchDelUserTpa } from '@/api/mdp/sys/userTpa';
	import  UserTpaAdd from './UserTpaAdd';//新增界面
	import  UserTpaEdit from './UserTpaEdit';//修改界面
	...
	export default {
		...
		components: {
		    'user-tpa-add':UserTpaAdd,
		    'user-tpa-edit':UserTpaEdit,
