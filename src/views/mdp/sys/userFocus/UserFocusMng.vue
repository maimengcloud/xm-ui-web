<template>
	<section class="page-container border padding">
		<el-row>
			...
			<el-button v-loading="load.list" :disabled="load.list==true" @click="searchUserFocuss" icon="el-icon-search">查询</el-button>
		...
		<el-row class="padding-top">
			<!--列表 UserFocus 我关注的项目或者任务-->
			<el-table ref="userFocusTable" :data="userFocuss" :height="maxTableHeight" @sort-change="sortChange" highlight-current-row v-loading="load.list" border @selection-change="selsChange" @row-click="rowClick" style="width: 100%;">
				...
				-->
				<el-table-column prop="userid" label="用户编号" min-width="120" show-overflow-tooltip  fixed="left"></el-table-column>				<el-table-column prop="bizId" label="关注的对象主键" min-width="120" show-overflow-tooltip  fixed="left"></el-table-column>				<el-table-column prop="pbizId" label="对象上级编号,项目时填项目编号，任务时填项目编号，产品时填产品编号，需求时填产品编号，bug时填产品编号，迭代时填产品编号" min-width="120" show-overflow-tooltip  fixed="left"></el-table-column>
				<el-table-column prop="username" label="用户名称" min-width="120" show-overflow-tooltip>
				    <template slot-scope="scope">
				        <span> {{scope.row.username}} </span>
                    </template>
				</el-table-column>
				<el-table-column prop="focusType" label="对象类型:项目-1/任务-2/产品-3/需求-4/bug-5/迭代-6/团队-7/组织-8/个人-9/文章-W/合同-H/客户-K" min-width="120" show-overflow-tooltip>
				    <template slot-scope="scope">
		...
		<el-row>
			<!--编辑 UserFocus 我关注的项目或者任务界面-->
			<el-drawer title="编辑我关注的项目或者任务" :visible.sync="editFormVisible"  size="60%"  append-to-body   :close-on-click-modal="false">
			    <user-focus-edit op-type="edit" :user-focus="editForm" :visible="editFormVisible" @cancel="editFormVisible=false" @submit="afterEditSubmit"></user-focus-edit>
			</el-drawer>

			<!--新增 UserFocus 我关注的项目或者任务界面-->
			<el-drawer title="新增我关注的项目或者任务" :visible.sync="addFormVisible"  size="60%"  append-to-body  :close-on-click-modal="false">
			    <user-focus-edit op-type="add" :visible="addFormVisible" @cancel="addFormVisible=false" @submit="afterAddSubmit"></user-focus-edit>
			</el-drawer>
	    </el-row>
	</section>
</template>
...
import { listUserFocus, delUserFocus, batchDelUserFocus,editSomeFieldsUserFocus } from '@/api/mdp/sys/userFocus';
import  UserFocusEdit from './UserFocusEdit';//新增修改界面
