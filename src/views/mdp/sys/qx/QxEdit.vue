		...
		<el-row class="app-container">
			...
			<el-form :model="editForm"  label-width="120px" :rules="editFormRules" ref="editForm"> 
				<el-form-item label="权限编码" prop="qxId">
					<el-input v-model="editForm.qxId" auto-complete="off"></el-input>
				</el-form-item> 
				<el-form-item label="权限名称" prop="qxName">
					<el-input v-model="editForm.qxName" auto-complete="off"></el-input>
				</el-form-item> 
				<el-form-item label="业务分类" prop="moduleId">
					<el-radio-group v-model="editForm.moduleId" >
...
<script>
	...
	import { editQx } from '@/api/mdp/sys/qx';
	...
	export default {
		...
		methods: {
			...
			//新增提交Qx 权限定义 父组件监听@submit="aftereditSubmit"
			editSubmit: function () {
		...
		mounted() {
			this.editForm=Object.assign(this.editForm, this.qx);  
			/**在下面写其它函数***/ 
			//加载下拉列表 如有需要去掉注释 
