	...
	<section class="page-container border">
		...
		<el-row class="page-main">
			...
			<el-table  ref="table" :height="tableHeight"  :data="procdefs"    highlight-current-row v-loading="listLoading" border @selection-change="selsChange" @row-click="rowClick" style="width: 100%;">
				...
				<el-table-column sortable prop="deploymentId" label="部署编号" min-width="80" ></el-table-column>
				<el-table-column sortable prop="resourceName" label="模型文件名称" min-width="80" ></el-table-column>
				<el-table-column sortable prop="dgrmResourceName" label="图片名称" min-width="80" ></el-table-column>
				<el-table-column sortable prop="description" label="描述" min-width="80" ></el-table-column> 
				<el-table-column label="操作" min-width="150"  fixed="right" >
					<template slot-scope="scope">
						<el-button   @click="showDiagram( scope.row,scope.$index)">流程图</el-button>
						<el-button v-if="scope.row.suspensionState=='1' " type="danger"  @click="handleSuspend(scope.row,scope.$index)">挂起</el-button>
						<el-button v-if="scope.row.suspensionState!='1' "  @click="handleActivate(scope.row,scope.$index)">激活</el-button>
					</template>
				</el-table-column>
			</el-table>
...
<script>
	...
	import { suspendProcdef,activateProcdef,listProcdef,listCategorys } from '../../../../../api/mdp/workflow/re/procdef';
